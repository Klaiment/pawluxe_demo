...
import { CheckCircle, ArrowLeft, Gift, Truck, Star, Heart, Mail } from "lucide-react"
                ...
                <div className="max-w-2xl mx-auto text-center">
                        ...
                        <CardContent className="p-6">
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="text-sm text-muted-foreground">Votre commande sera expédiée rapidement</p>
                                </div>
                                <div className="space-y-2">
                    ...
                    <div className="bg-gradient-to-r from-amber-100 to-orange-100 rounded-lg p-6 mb-8 border border-amber-200">
                        <div className="flex items-center justify-center mb-3">
                            ...
                            <span className="font-semibold text-amber-800">Message spécial</span>
                        </div>
                        <p className="text-amber-700 leading-relaxed">
                            Chez PawLuxe, chaque commande est préparée avec amour et attention. Votre compagnon mérite ce qu'il y a de
                            mieux, et nous sommes fiers de contribuer à son bonheur. Merci de faire partie de la famille PawLuxe !
                        </p>
                    </div>
                    ...
                    <div className="text-center space-y-2 text-sm text-muted-foreground">
                        <p>Besoin d'aide ? Contactez notre service client au +33 1 23 45 67 89</p>
