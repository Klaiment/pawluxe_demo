    ...
    const addToCart = (item: CartItem) => {
        setCart((prevCart) => {
            ...
            if (existingItemIndex !== -1) {
                ...
                const finalQuantity = Math.min(newQuantity, item.variantList.items[0].actualStockLevel)
                        ...
                        <div className="flex items-center gap-3 mt-2">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-sm text-gray-500">
                                    ...
                                    {formatCurrency(item.variantList.items[0].priceWithTax * finalQuantity, "€")}
                                </p>
                            </div>
                        </div>
                    ),
                ...
                description: (
                    <div className="flex items-center gap-3 mt-2">
                        ...
                        <div className="flex-1">
                            <p className="font-medium text-gray-900">{item.name}</p>
                            <p className="text-sm text-gray-500">
                                Nouvelle quantité: {quantity} • {formatCurrency(item.variantList.items[0].priceWithTax * quantity, "€")}
                            </p>
                        </div>
                    </div>
                ),
