      ...
      <div className="container mx-auto px-4 md:px-6 relative z-30">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-white/90 mb-8 max-w-xl leading-relaxed">
            Des accessoires raffinés et des produits haut de gamme pour les
            animaux de compagnie qui méritent ce qu'il y a de mieux. Conçus avec
            passion, fabriqués avec excellence.
          </p>
