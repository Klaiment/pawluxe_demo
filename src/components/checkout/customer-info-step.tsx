...
import { setCustomerForOrder, setOrderBillingAddress, getCurrentOrder } from "@/services/orderService"
    ...
    try {
      ...
      if (!currentOrder?.customer) {
        try {
          ...
          console.warn("Customer already exists or cannot be set:", customerError)
